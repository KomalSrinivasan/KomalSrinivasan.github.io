...
! function(t, e) {
  ...
  var L = carousel,
    ...
    at = function() {
      ...
      return t.next = function() {
        ...
        if (!inputtextareai.test(t.target.tagName)) switch (t.which) {
          case 37
    ...
    Ct = function() {
      ...
      return t.toggle = function() {
        ...
        return this.each(function() {
          ...
          if (!e && n.toggle && showhide.test(i) && (n.toggle = !1), e  (e = new a(this, n), t.data(ct, e)), string == typeof i) {
  ...
  function Lt(t) {
    ...
    var e = Nt(t),
      ...
      i = e.overflowX,
      o = e.overflowY;
    return (autoscrolloverlay).test(n + o + i)  t  Lt(kt(t))
  }
  ...
  function te(t) {
    ...
    return t.replace(leftrightbottomtopg, function(t) {
      return e[t]
    })
  }
  ...
  var ue = Tt && Firefoxi.test(navigator.userAgent);
  ...
  var we = dropdown,
    ...
    Fe = .dropdown-menu,
    Me = .navbar-nav,
    We = .dropdown-menu .dropdown-itemnot(.disabled)not(disabled),
    Ue = top-start,
    Be = top-end,
    qe = bottom-start,
    Ke = bottom-end,
    ...
    Xe = function() {
      ...
      return t.toggle = function() {
        if (!this._element.disabled && !p(this._element).hasClass(Oe)) {
          ...
          if (c._clearMenus(), !e) {
            ...
            if (p(t).trigger(i), !i.isDefaultPrevented()) {
              if (!this._inNavbar) {
                if (undefined == typeof be) throw new TypeError(Bootstrap's dropdowns require Popper.js (httpspopper.js.org));
                var o = this._element;
        ...
        if (!t  3 !== t.which && (keyup !== t.type  9 === t.which))
          for (var e = [].slice.call(document.querySelectorAll(je)), n = 0, i = e.length; n  i; n++) {
            ...
            if (t && click === t.type && (s.clickEvent = t), r) {
              var a = r._menu;
              if (p(o).hasClass(Ne) && !(t && (click === t.type && inputtextareai.test(t.target.tagName)  keyup === t.type && 9 === t.which) && p.contains(o, t.target))) {
        ...
        if ((inputtextareai.test(t.target.tagName)  !(32 === t.which  27 !== t.which && (40 !== t.which && 38 !== t.which  p(t.target).closest(Fe).length))  Ie.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(Oe))) {
  ...
  var _n = [background, cite, href, itemtype, longdesc, poster, src, xlinkhref],
    vn = {
    ...
    yn = ^((httpsmailtoftptelfile)[^&#]([#]$))gi,
    En = ^data(image(bmpgifjpegjpgpngtiffwebp)video(mpegmp4oggwebm)audio(mp3ogaoggopus));base64,[a-z0-9+]+=$i;

  function bn(t, s, e) {
    if (0 === t.length) return t;
    if (e && function == typeof e) return e(t);
    for (var n = (new window.DOMParser).parseFromString(t, texthtml), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll()), i = function(t, e) {
        var n = l[t],
  ...
  var wn = tooltip,
    ...
    kn = {
      animation !0,
      template 'div class=tooltip role=tooltipdiv class=arrowdivdiv class=tooltip-innerdivdiv',
      trigger hover focus,
      title ,
      delay 0,
      html !1,
    ...
    qn = function() {
      function i(t, e) {
        if (undefined == typeof be) throw new TypeError(Bootstrap's tooltips require Popper.js (httpspopper.js.org));
      ...
      return t.enable = function() {
        ...
        return this.each(function() {
          var t = p(this).data(Cn),
            e = object == typeof n && n;
          if ((t  !disposehide.test(n)) && (t  (t = new i(this, e), p(this).data(Cn, t)), string == typeof n)) {
            if (undefined == typeof t[n]) throw new TypeError('No method named ' + n + '');
            t[n]()
          }
        })
  ...
  var Kn = popover,
    ...
    Gn = l({}, qn.Default, {
      ...
      trigger click,
      content ,
      template 'div class=popover role=tooltipdiv class=arrowdivh3 class=popover-headerh3div class=popover-bodydivdiv'
    }),
    $n = l({}, qn.DefaultType, {
    ...
    ii = function(t) {
      ...
      return o.isWithContent = function() {
        ...
        return this.each(function() {
          ...
          if ((t  !disposehide.test(n)) && (t  (t = new i(this, e), p(this).data(Qn, t)), string == typeof n)) {
            if (undefined == typeof t[n]) throw new TypeError('No method named ' + n + '');
            t[n]()
          }
        })
